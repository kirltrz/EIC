...
void ui_otaScreen_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Button24, lv_color_hex(0xEAC7C7), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button26, lv_color_hex(0xA0C3D2), LV_PART_MAIN | LV_STATE_DEFAULT);
