...
// PID控制参数 - 位置锁定时使用
float HOLD_POS_KP = 50.0f;    // 位置保持比例系数
float HOLD_POS_KI = 0.1f;     // 位置保持积分系数
float HOLD_POS_KD = 15.0f;    // 位置保持微分系数
float HOLD_YAW_KP = 100.0f;   // 偏航角保持比例系数
float HOLD_YAW_KI = 0.1f;     // 偏航角保持积分系数
float HOLD_YAW_KD = 15.0f;    // 偏航角保持微分系数
